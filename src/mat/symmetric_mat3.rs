...
macro_rules! symmetric_mat3s {
    ($($n:ident => $nonsymmetricn:ident, $qt:ident, $m2t:ident, $v2t:ident, $vt:ident, $t:ident, $nonwidet:ident),+) => {
        $(
        ...
        impl $n {
            ...
            pub const fn from_diagonal(diagonal: $vt) -> Self {
                Self::new(diagonal.x, $t::ZERO, diagonal.y, $t::ZERO, $t::ZERO, diagonal.z)
            }
...
macro_rules! impl_wide_symmetric_mat3s {
    ($($n:ident => $nonwiden:ident, $qt:ident, $m2t:ident, $v2t:ident, $vt:ident, $t:ident, $nonwidet:ident),+) => {
        $(
        impl $n {
            /// Creates a new symmetric 3x3 matrix from its bottom left triangle, including diagonal elements,
...
symmetric_mat3s!(
    SymmetricMat3 => Mat3, Quat, Mat2, Vec2, Vec3, f32, f32,
    SymmetricMat3x4 => Mat3x4, Quatx4, Mat2x4, Vec2x4, Vec3x4, f32x4, f32,
    SymmetricMat3x8 => Mat3x8, Quatx8, Mat2x8, Vec2x8, Vec3x8, f32x8, f32
);

#[cfg(feature = "f64")]
symmetric_mat3s!(
    DSymmetricMat3 => DMat3, DQuat, DMat2, DVec2, DVec3, f64, f64,
    DSymmetricMat3x2 => DMat3x2, DQuatx2, DMat2x2, DVec2x2, DVec3x2, f64x2, f64,
    DSymmetricMat3x4 => DMat3x4, DQuatx4, DMat2x4, DVec2x4, DVec3x4, f64x4, f64
);

impl_scalar_symmetric_mat3s!(
    SymmetricMat3 => Quat, Mat2, Vec2, Vec3, f32
);

#[cfg(feature = "f64")]
impl_scalar_symmetric_mat3s!(
    DSymmetricMat3 => DQuat, DMat2, DVec2, DVec3, f64
);

impl_wide_symmetric_mat3s!(
    SymmetricMat3x4 => SymmetricMat3, Quatx4, Mat2x4, Vec2x4, Vec3x4, f32x4, f32,
    SymmetricMat3x8 => SymmetricMat3, Quatx8, Mat2x8, Vec2x8, Vec3x8, f32x8, f32
);

#[cfg(feature = "f64")]
impl_wide_symmetric_mat3s!(
    DSymmetricMat3x2 => DSymmetricMat3, DQuatx2, DMat2x2, DVec2x2, DVec3x2, f64x2, f64,
    DSymmetricMat3x4 => DSymmetricMat3, DQuatx4, DMat2x4, DVec2x4, DVec3x4, f64x4, f64
);
